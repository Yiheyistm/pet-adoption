...
import 'package:pet_adoption/views/widgets/new_pets_card.dart';
import 'package:pet_adoption/views/widgets/pet_detial.dart';
import 'package:pet_adoption/views/widgets/top_pets_card.dart';
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => PetDetail(pet: myPetDetails)));
                    },
                    child: TopPetsCard(
                      pet: myPetDetails,
